...
if __name__ == "__main__":
    # 加载模型
    # model = YOLO("ultralytics-8.3.12/runs/train/exp/weights/best.pt")
    model = YOLO(r"G:\YOLOv8-Magic-8.3.12\YOLOv8-Magic-8.3.12\ultralytics-8.3.12\runs\train\exp23\best.pt")
    # 验证模型
    metrics = model.val(
        data="ultralytics\cfg\datasets\mydata.yaml",
