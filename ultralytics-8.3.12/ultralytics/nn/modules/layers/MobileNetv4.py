...
MNV4ConvSmall_BLOCK_SPECS = {
    ...
    "layer2": {
        "block_name": "convbn",
        "num_blocks": 2,
        "block_specs": [[32, 64, 3, 2], [64, 64, 1, 1]],
    },
    "layer3": {
        "block_name": "uib",
        "num_blocks": 6,
    ...
    "layer5": {
        "block_name": "convbn",
        "num_blocks": 2,
        "block_specs": [[128, 256, 1, 1], [256, 256, 1, 1]],
    },
}
    ...
    def __init__(self, inp, oup, stride, expand_ratio, act=False):
        ...
        if expand_ratio != 1:
            self.block.add_module(
                "exp_1x1", conv_2d(inp, hidden_dim, kernel_size=1, stride=1)
            )
        self.block.add_module(
            "conv_3x3",
            conv_2d(
        ...
        self.block.add_module(
            "red_1x1", conv_2d(hidden_dim, oup, kernel_size=1, stride=1, act=act)
        )
...
class MobileNetV4(nn.Module):
    def __init__(self, model, i):
        ...
        self.channel = self.get_output_channels(torch.randn(1, 3, 640, 640), i)
