# 论文地址：https://arxiv.org/pdf/2211.15444.pdf
# 代码地址：https://github.com/tinyvision/DAMO-YOLOhttps://blog.csdn.net/weixin_43694096/article/details/135730418
# 博客地址：https://blog.csdn.net/weixin_43694096/article/details/135730418
...
class BasicBlock_3x3_Reverse(nn.Module):
    def __init__(
        self, ch_in, ch_hidden_ratio, ch_out, act="relu", shortcut=True, depthwise=False
    ):
        ...
        if not depthwise:
            ...
            self.conv = MobileV3Block(
                in_c=ch_in, out_c=ch_out, btn_c=None, kernel_size=5, stride=1, act=act
            )
