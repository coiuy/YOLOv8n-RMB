...
if __name__ == "__main__":
    # 加载模型
    model = YOLO(r"G:\YOLOv8-Magic-8.3.12\YOLOv8-Magic-8.3.12\ultralytics-8.3.12\ultralytics\cfg\models\v8\yolov8.yaml")  # 不使用预训练权重从头训练
    # model = YOLO(r'yolov8.yaml').load("yolov8n.pt") # 使用预训练权重训练
    # 训练参数 ----------------------------------------------------------------------------------------------
    model.train(
        data=r"G:\YOLOv8-Magic-8.3.12\YOLOv8-Magic-8.3.12\ultralytics-8.3.12\ultralytics\cfg\datasets\mydata.yaml",
